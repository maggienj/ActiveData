...
def to_painless(self, not_null=False, boolean=False, many=False):
    ...
    expr = "((" + test_v + ") || (" + test_l + ")) ? null : (" + v + ".substring(min(" + v + ".length(), max(0, (" + v + ").length()) " + "\"params\":" + "{\"length\":" + l + "}).intValue())"
    return expr
...
def to_painless(self, not_null=False, boolean=False, many=False):
    ...
    expr = "((" + test_v + ") || (" + test_l + ")) ? null : (" + v + ".substring(0, min(" + v + ".length(), max(0, (" + v + ").length()) " + "\"params\":" + "{\"length\":" + l + "}).intValue())"
    return expr
